...
//        add more machzorim!!!!!!!!!!!!!!!!!!
    ...
    public static String convertDateToHebrewDate(String englishDate){
        ...
        return String.format(Locale.getDefault(),"%s  %s  %s", ConvertIntToPage.intToPage(h.get(HebrewCalendar.DAY_OF_MONTH)), month, ConvertIntToPage.intToPage(h.get(HebrewCalendar.YEAR)));
    }
